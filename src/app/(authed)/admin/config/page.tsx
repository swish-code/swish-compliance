...
import { CONFIG_KINDS } from "@/features/config/types";
...
export default async function ConfigPage() {
  ...
  // Pre-fetch every editable kind in parallel.
  ...
  return (
    <Workspace
      section="Administration / Config"
      subtitle="System configuration — manage dropdown options used across the app"
