...
/** Departments tab body — was the whole /admin/departments page before
 *  the admin pages were consolidated into /admin/config's tabs (user
 *  spec 2026-08-17). */
export default async function DepartmentsTabContent() {
