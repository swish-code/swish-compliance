import { listOrgUnitsAsTree } from "./repository";
import {
  createOrgUnitAction,
  updateOrgUnitAction,
  deleteOrgUnitAction,
...
/** Org Units tab body — was the whole /admin/org-units page before the
 *  admin pages were consolidated into /admin/config's tabs (user spec
 *  2026-08-17). */
export default async function OrgUnitsTabContent() {
